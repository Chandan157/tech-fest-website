    ...
    >
      <div className="max-w-screen-xl py-10 px-4 sm:px-6 text-dimWhite border-t border-white sm:flex justify-between mx-auto">
        ...
        <div className="p-5 sm:w-2/12  text-center">
          <div className="text-sm uppercase text-accent font-bold mb-4">
            Quick Links
          </div>
          <ul className="text-sm text-center">
            ...
            <li className="my-2">
              <a className="hover:text-accent" href="/#events">
                Events
              </a>
            </li>
            <li className="my-2">
            ...
            <li className="my-2">
              <a className="hover:text-accent" href="/#glimpse">
                Glimpse
              </a>
            </li>
          </ul>
        ...
        <div className="p-5 sm:w-2/12 text-center">
          ...
          <ul className="text-sm text-center">
            ...
            <li className="my-2">
              <a
                className="hover:text-accent"
                href="https://www.instagram.com/vprayuktibit?igsh=ZWI2YzEzYmMxYg=="
                rel="noreferrer"
                target="_blank"
              >
                Instagram
        ...
        <div className="p-5 text-center sm:w-3/12">
          ...
          <ul className="text-sm">
            <li className="my-2">
              ...
              <a className="hover:text-accent" href="tel:9688515799">
                9688515799
              </a>
            </li>
            <li className="my-2">
              <p className="">Mr. Sree Poorvishaa M</p>
              <a className="hover:text-accent" href="tel:9345899487">
                9345899487
              </a>
            </li>
          </ul>
      ...
      <div className="flex py-5 m-auto text-dimWhite text-sm flex-col items-center border-t max-w-screen-xl border-white">
        <div className="my-2 text-center leading-6">
          Developed by
          <br />
          <span className="text-accent">
            <a
              href="https://abhra.xyz"
              target="_blank"
              rel="noreferrer"
            >
              Abhradeep Barman
