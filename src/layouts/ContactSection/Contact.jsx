  ...
  return (
    ...
    >
      <div className="container max-w-6xl text-center mx-auto px-5 md:px-2">
        ...
        >
          Having Questions?
          {/* <span className='text-2xl'>&nbsp;Horizon'24</span> */}
        </h2>
        <h3
          data-aos="fade-up"
          data-aos-offset="10"
        ...
        >
          <div class="basis-full flex flex-row gap-10 flex-wrap justify-evenly md:basis-3/3 ">
            <div>
              ...
              <p class="mt-2 text-sm text-dimWhite">
              ...
              <a
                ...
                rel="noopener"
                target="_top"
                class="mt-2 text-sm cursor-pointer text-accent"
              >
                info@bcrec.ac.in
              </a>
            </div>
            ...
            <div>
              ...
              <a
                ...
                rel="noreferrer"
                target="_blank"
                class="mt-2 text-sm text-accent cursor-pointer"
              >
            ...
            <div>
              ...
              <a
                class="mt-2 text-base font-[500] cursor-pointer text-accent"
                rel="noreferrer"
                target="_blank"
                href="tel:6381137437"
              >
