...
export const HeroSectionMd = () => {
  return (
    ...
    >
      ...
      <Spline
        scene="https://prod.spline.design/IAeOGaFL5m9bW140/scene.splinecode"
        className="hero-video absolute -z-10 top-0 left-0 w-full object-cover h-full"
      />
      {/* <Spline
      ...
      <div className="welcome-text relative top-0 left-0 w-full px-60 h-[100vh] flex items-center justify-center bg-primary  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-[0.2] flex-col">
        ...
        <img
          className="mb-10 w-[60%] na:w-[70%] lg:w-[40%] sm:w-[40%]"
          src={Horizon_logo}
          alt="logo"
          data-aos="fade-up"
          data-aos-offset="10"
...
export const HeroSectionSm = () => {
  return (
    ...
    >
      ...
      >
        <source id="mp4" src={Bgvideo} type="video/mp4" />
      </video>
      <div className="video-overlay aspect-[9/16]"></div>
      <div className="welcome-text relative inset-0 top-10 w-full h-[90vh] px-5 aspect-[9/16] flex items-start justify-center  bg-black  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-[0.3]  flex-col">
        <img
          className="mb-20 "
          src={Horizon_logo}
          alt="logo"
